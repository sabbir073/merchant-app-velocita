...
public class ReturnParcelActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Return Parcel List");
        ...
        startdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                datePickerDialog = new DatePickerDialog(ReturnParcelActivity.this,
    ...
    private void dataInitialize() {
        progressDialog = new ProgressDialog(ReturnParcelActivity.this);
        progressDialog.setMessage("Please Wait......");
        progressDialog.setCancelable(false);
        progressDialog.show();
        api.getpercellistByFiltering("6").enqueue(new Callback<PercelContainer>() {
            @Override
            public void onResponse(Call<PercelContainer> call, Response<PercelContainer> response) {
                ...
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    try {
                        Toast.makeText(ReturnParcelActivity.this, "something wrong" + response.errorBody().string(), Toast.LENGTH_SHORT).show();
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
                    Log.e("eorrrr", response.toString());
            ...
            public void onFailure(Call<PercelContainer> call, Throwable t) {
                progressDialog.dismiss();
                Toast.makeText(ReturnParcelActivity.this, "something wrong", Toast.LENGTH_SHORT).show();
            }
        });
                    ...
                    public void onResponse(Call<PercelContainer> call, Response<PercelContainer> response) {
                        if (response.isSuccessful() && response.body() != null) {
                            ...
                            if (response.isSuccessful() && response.body() != null) {
                                ...
                                PercelListAdapter adapter = new PercelListAdapter(response.body().getPercels(), ReturnParcelActivity.this, new PercelListAdapter.OnItemClickListener() {
                                    @Override
                                    public void onItemClick(int position) {
                                        dataInitialize();
                                    }
